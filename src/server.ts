...
export const SERVER_NAME = 'cisco-axl-mcp';
...
export interface CiscoAxlMcpServerOptions {
...
export class CiscoAxlMcpServer {
  ...
  constructor(
    ...
    options: CiscoAxlMcpServerOptions = {}
  ) {
  ...
  /** Close this server instance and abort in-flight requests */
...
export function createMcpServer(
  ...
  return new CiscoAxlMcpServer(config, runtime ?? createStartupRuntime(config), {
    handleSignals: false,
  });
}
